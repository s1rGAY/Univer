...
class ViewComponent(MDScreen):
    ...
    def __init__(self, **kw):
        ...
        self.stack_layout.add_widget(self.deep_save)
        self.stack_layout.add_widget(self.exit_button)

        self.screen.add_widget(self.computer_label)
    ...
    def update_label(self):
        self.computer_label.text = self.controller.update_computer_information()
